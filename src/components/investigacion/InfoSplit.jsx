  ...
  return (
    ...
    >
      <div className={reverse ? 'lg:order-2' : ''}>
        ...
        <button className="group/cta mt-8 inline-flex cursor-pointer items-center gap-2 text-[12px] font-semibold uppercase tracking-[0.22em] text-[rgb(var(--brand-dark))] transition-colors hover:text-[rgb(var(--brand-base))]">
          {ctaLabel}
