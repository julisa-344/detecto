    ...
    >
      ...
      <div className="grid items-stretch gap-6 lg:grid-cols-[1fr_1.1fr] lg:gap-10">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-4xl min-h-130 lg:min-h-[620px] flex items-center justify-center bg-linear-to-br from-[rgb(var(--brand-base)/0.12)] to-[rgb(var(--brand-med)/0.08)]">
            <img
              src={quienesImg}
