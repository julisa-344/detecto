      ...
      <div className="relative z-20 mx-auto w-full max-w-7xl px-6 py-20 lg:px-12 lg:py-28">
        ...
        >
          ...
          <p className="max-w-xl text-base font-light leading-relaxed text-slate-200 lg:text-[17px]">
            Combinamos equipos de alta calidad con médicos radiólogos
            especializados para entregarte diagnósticos claros, oportunos y
            seguros que te ayuden a tomar decisiones informadas sobre tu
            tratamiento.
          </p>
