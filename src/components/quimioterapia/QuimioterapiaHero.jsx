      ...
      <div className="relative z-20 mx-auto w-full max-w-7xl px-6 py-20 lg:px-12 lg:py-28">
        ...
        >
          ...
          <p className="max-w-xl text-base font-light leading-relaxed text-slate-200 lg:text-[17px]">
            Diseñamos esquemas de quimioterapia ajustados a tu diagnóstico,
            historia clínica y objetivos terapéuticos, con seguimiento de tu
            respuesta y de posibles efectos secundarios para actuar a tiempo.
          </p>
