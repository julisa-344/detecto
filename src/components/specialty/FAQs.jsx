                ...
                >
                  <div className="flex items-center gap-6 py-5 px-1">
                    <div className="relative flex items-center justify-center w-10 h-10 shrink-0">
                      <motion.div
                        className="absolute inset-0 rounded-full bg-[rgb(var(--brand-dark))]"
                        initial={false}
                        animate={{
                    ...
                    <motion.h3
                      ...
                      animate={{
                        ...
                        color: isActive || isHovered ? 'rgb(var(--brand-dark))' : '#64748B',
                      }}
                    ...
                    <div className="ml-auto flex items-center gap-3 shrink-0">
                      ...
                      >
                        <motion.svg
                          ...
                          viewBox="0 0 16 16"
                          fill="none"
                          className="text-[rgb(var(--brand-dark))]"
                  ...
                  <motion.div
                    className="absolute bottom-0 left-0 h-px bg-[rgb(var(--brand-dark))] origin-left"
                    initial={{ scaleX: 0 }}
