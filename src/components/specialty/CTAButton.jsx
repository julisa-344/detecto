...
export default function CTAButton({ label = 'AGENDAR CITA' }) {
  return (
    <button className="group relative flex cursor-pointer items-center justify-center gap-0 rounded-full border-none bg-transparent p-0 transition-all active:scale-95">
      ...
      <div className="relative flex h-[52px] w-[52px] items-center justify-center overflow-hidden rounded-full transition-all duration-500 ease-in-out bg-[rgb(var(--brand-base))] text-white group-hover:bg-[rgb(var(--brand-dark))] backdrop-blur-md">
