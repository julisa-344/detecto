...
const quienesImg = `${import.meta.env.VITE_BASE_IMAGE_URL}preventivos/preventivoAzul.gif`
    ...
    >
      <div className="mb-12 grid items-end gap-8 lg:grid-cols-[1.5fr_1fr] lg:gap-12">
        ...
        <p className="max-w-md text-[15px] font-light leading-7 text-slate-500 lg:border-l lg:border-[rgb(var(--brand-base)/0.3)] lg:pl-8">
          Una evaluación completa, clara y enfocada en prevención. Diseñada
          para que puedas realizarte tus pruebas en una sola visita.
        </p>
      </div>
