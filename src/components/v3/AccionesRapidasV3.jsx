...
import accionesRapidasVideo from '../../assets/accionesrapidas.mp4'
    ...
    <section className="bg-white py-20 px-6 lg:px-10">
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          {/* BLOQUE 1: Video con título */}
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, amount: 0.08 }}
            className="relative h-[500px] lg:h-full min-h-[500px] overflow-hidden rounded-2xl group bg-primary-dark"
          >
            <video
              src={accionesRapidasVideo}
              autoPlay
              muted
              loop
              playsInline
            ...
            <div className="absolute bottom-12 left-8 right-8 lg:left-12 lg:right-12">
              <h2 className="text-4xl lg:text-5xl font-bold text-white leading-tight tracking-tight">
                Resuelve <br />
                tu salud <br />
                <span className="font-light italic">desde aquí.</span>
              </h2>
            </div>
          </motion.div>

          {/* BLOQUE 2: Cuadrícula de acciones */}
