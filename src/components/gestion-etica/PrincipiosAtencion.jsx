    ...
    <section className="relative -mx-6 rounded-4xl bg-(--brand-bg-ultra) px-6 py-16 lg:-mx-12 lg:px-12 lg:py-20">
      <div className="mb-10 max-w-2xl">
        ...
        <p className="max-w-xl text-[15px] font-light leading-7 text-slate-500">
          Fundamentos compartidos con nuestro Comité de Ética, aplicados en
        ...
        {principios.map((p, i) => {
          ...
          return (
            <motion.div
              ...
              className="group relative flex flex-col overflow-hidden rounded-4xl bg-white p-6 transition-all hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgb(var(--brand-med)/0.25)]"
            >
              ...
              <h3 className="mt-6 text-lg font-medium leading-snug text-[rgb(var(--brand-dark))]">
                {p.title}
              </h3>
