...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-br from-primary-medium/15 via-transparent to-gray-950/70 z-10" />
      ...
      <div className="relative z-20 w-full max-w-6xl mx-auto px-6 lg:px-8 grid lg:grid-cols-[1fr_auto] gap-12 items-center">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-white/5 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.45)] p-8 lg:p-10">
            {/* Brillo decorativo */}
            ...
            <div className="relative">
              ...
              <h2 className="mt-3 text-3xl font-extralight text-white tracking-tight leading-tight">
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                {/* DNI */}
                <div>
                  <label className="block text-[12px] font-medium tracking-[0.25em] uppercase text-white/60 mb-2">
                    Número de DNI
                  </label>
                  <div className="group relative flex items-center rounded-xl border border-white/15 bg-white/5 backdrop-blur-md transition-all focus-within:border-primary/60 focus-within:bg-white/10">
                    <User className="ml-4 h-4 w-4 text-white/40 group-focus-within:text-primary transition-colors" />
                    <input
                      type="text"
                      inputMode="numeric"
                      maxLength={8}
                      ...
                      className="w-full bg-transparent px-3 py-3.5 text-sm font-light text-white placeholder-white/30 outline-none"
                      required
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="group relative flex items-center rounded-xl border border-white/15 bg-white/5 backdrop-blur-md transition-all focus-within:border-primary/60 focus-within:bg-white/10">
                    <Lock className="ml-4 h-4 w-4 text-white/40 group-focus-within:text-primary transition-colors" />
                    <input
                    ...
                    <button
                      ...
                      className="mr-3 p-1.5 text-white/40 hover:text-white transition-colors"
                ...
                <div className="flex justify-center pt-3">
                  ...
                  >
                    <span className="rounded-full px-8 py-4 text-[11px] font-semibold tracking-[0.18em] text-white transition-all duration-500 ease-in-out bg-primary group-hover:bg-primary-dark backdrop-blur-md">
                      VER MIS RESULTADOS
                    </span>
                    <div className="relative flex h-13 w-13 items-center justify-center overflow-hidden rounded-full transition-all duration-500 ease-in-out bg-primary text-white group-hover:bg-primary-dark backdrop-blur-md">
